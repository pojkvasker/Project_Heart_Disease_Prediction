...
bp_s = plt.hist(sick['trestbps'].astype(int), bins=bins, **kwargs, edgecolor='red')
bp_g = plt.hist(good['trestbps'].astype(int), bins=bins, **kwargs, edgecolor='green')
int_discr["bp"] = intrinsic_discrepancy(bp_s[0],bp_g[0])

plt.figure(5)
plt.xlabel('serum cholestoral in mg/dl')
chol_s = plt.hist(sick['chol'].astype(int), bins=bins, **kwargs, edgecolor='red')
chol_g = plt.hist(good['chol'].astype(int), bins=bins, **kwargs, edgecolor='green')
